...
const Events = () => {
    ...
    const renderSmallBlock = (text) => (
        <div style={smallBlockStyle}>{text}</div>
    );
    ...
    return (
        <div style={containerStyle}>
            <div style={leftSideStyle}>
                <div>
                    <p style={{ fontWeight: 'bold', fontSize: '28px' }}>WEBINAR ON</p>
                    <h1 style={{ fontWeight: 'bold', fontSize: '48px', marginBottom: '5px' }}>Simulating Corrosion & Corrosion</h1>
                    <h1 style={{ fontWeight: 'bold', fontSize: '48px', marginBottom: '5px' }}>Protection for Oil And Gas Equipment</h1>
                    <h3 style={{fontSize: '25px' }}>march 10th 2024 (11:00 am to 1:00 pm)</h3>
                </div>
